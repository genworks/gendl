...
(asdf:defsystem #:regression :description
 "The Gendl\" regression Subsystem" :author "Dave Cooper" :license
 "Affero Gnu Public License (http://www.gnu.org/licenses/)" :serial t
 :version "20151206" :depends-on (:lift :surf :tasty)
 ...
 ((:file "utils/source/package") (:file "utils/source/genworks")
  ...
  (:file "source/approximated-curve") (:file "source/arc-curve")

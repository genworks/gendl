...
(asdf:defsystem #:surf :description
 ...
 :serial t :version "20131206" :depends-on (:geom-base)
 #-asdf-unicode :defsystem-depends-on #-asdf-unicode (:asdf-encodings)
 #+asdf-encodings :encoding #+asdf-encodings :utf-8
 :components
 ((:file "source/parameters") (:file "source/classes")
  (:file "source/methods") (:file "source/curve")
  (:file "source/surface") (:file "source/3d-curve")
  (:file "source/approximated-curve")
  (:file "source/approximated-subsurface") (:file "source/arc-curve")
  ...
  (:file "source/cad-assembly") (:file "source/cardinal-spline")

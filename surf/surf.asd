...
(defsystem #:surf :description
           ...
           ((:file "source/parameters") (:file "source/classes")
            ...
            (:file "source/brep") (:file "source/breps-display")
            (:file "source/cad-assembly")
            (:file "source/cardinal-spline")
            ...
            (:file "source/extruded-solid") (:file "source/face")
            (:file "source/facial-brep")
            (:file "source/filleted-curve")
            (:file "source/fitted-conic")
            (:file "source/fitted-curve")
            (:file "source/fitted-surface") (:file "source/formats")

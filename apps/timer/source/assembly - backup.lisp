...
(define-object journal-entry () 
  ...
  :input-slots ((name)                    ; name of the user
		(email)                   ; email of the user
		(time-set)                ; amount of time timer was set for
		(universal-time-start)    ; actual time timer was started
		(universal-time-finish))  ; actual time timer ended
  ...
  ((id                                    ; unique identifier for this journal entry
   ...
   (time-elapsed                          ; actual amount of time elapsed
    (decode-universal-time 
     (- (the universal-time-finish) 
	(the universal-time-start)))) 
   (serialization                         ; string serialization of journal entry
    (write-string 
     (list 
      (the name) 
      (the email) 

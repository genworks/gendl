  ...
  ((title "Genworks International - News")
   ...
   (right-section-inner-html 
    (with-cl-who-string ()
      (:h2 "Prior News") 
      (:H3 "2012-03-01")
      (:p "Genworks GDL included as a standard dist with " ((:a :href "http://www.quicklisp.org") "Quicklisp") ".")
      ((:div :class "hr-dots")) 
      (:h3 "2012-02-01")
      (:p "Port of core Genworks GDL to " ((:a :href "http://www.sbcl.org") "Steel Bank Common Lisp") " is completed.")
      (:h3 "2012-01-01")
      (:p "Genworks GDL 1581 Stable Beta release available, available on "

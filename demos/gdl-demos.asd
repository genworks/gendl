...
(asdf:defsystem #:gdl-demos
  ...
  "2012050600"
  :depends-on
  (:gdl-gwl-graphics :gdl-surf)
  :components
  ((:file "robot/source/package") (:file "robot/source/assembly")
   (:file "newsite/source/package") (:file "newsite/source/locales")
   ...
   (:file "newsite/source/contact-us") (:file "newsite/source/demos")
   (:file "newsite/source/documentation")
   (:file "newsite/source/explanations")
   (:file "newsite/source/index") (:file "newsite/source/language")
   (:file "newsite/source/licensing") (:file "newsite/source/mixins")
   (:file "newsite/source/news") (:file "newsite/source/people")
   (:file "newsite/source/product-descriptions")
   (:file "newsite/source/product-licensing")
   (:file "newsite/source/products") (:file "newsite/source/publish")
   (:file "newsite/source/survey")
   (:file "twenty-four/source/infpre")
   (:file "twenty-four/source/assembly")
   (:file "twenty-four/source/cards-by-number")
   (:file "twenty-four/source/find") (:file "bus/source/package")
   (:file "bus/source/assembly") (:file "bus/source/body")
   (:file "bus/source/chassis") (:file "bus/source/interior")
   (:file "bus/source/rule-ackermann") (:file "bus/source/axle")
   (:file "bus/source/fleet") (:file "bus/source/frame-rail")
